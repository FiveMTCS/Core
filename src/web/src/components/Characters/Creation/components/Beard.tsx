...
const CharacterBeards: React.FC<IArgs> = ({
    ...
    const [beardOpacity, setBeardOpacity] = useState(
        character.skin.beardOpacity,
    );
            ...
            <>
                {list.map((index) => (
                    ...
                    >
                        <BeardImg
                            src={
                                require(`../../../../resources/img/facehairs/${index}.jpg`)
                                    .default
                            }
                        />
                        {currentValue === index && (
                ...
                <>
                    ...
                    <SliderWrapper>
                        <Branding.Fonts.Texts.Small
                            customStyle={'margin: 0; width: 88px;'}
                        >
                            {t('common.none')}
                        </Branding.Fonts.Texts.Small>
                        <LabeledSlider
                        ...
                        <Branding.Fonts.Texts.Small
                            customStyle={
                                'margin: 0;  width: 88px; text-align: right;'
                            }
                        >
                            {t('common.alot')}
                        </Branding.Fonts.Texts.Small>
